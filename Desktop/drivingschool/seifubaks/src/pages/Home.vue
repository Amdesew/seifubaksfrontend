        ...
        <div class="py-6">
          <div class="bg-gray-100 mx-auto max-w-lg rounded-2xl border-b-8 border-white">
            <div class="grid grid-cols-2  px-20 py-10">
              ...
              <p class="">Awarded Driving School In Amhara Region</p>
            </div>
          </div>
          ...
          <div class="bg-gray-100 mx-auto max-w-lg rounded-2xl border-b-8 border-white">
            <div class="grid grid-cols-2  px-20 py-10">
              ...
              <p>
                The Most Digitalized Driving School With Modern Simulators
              </p>
            </div>
          </div>
          ...
          <div class="bg-gray-100 mx-auto max-w-lg rounded-2xl">
            <div class="grid grid-cols-2  px-20 py-10">
              ...
              <p class="">The Best Technician And Resourcefull</p>
            </div>
          </div>
        </div>
